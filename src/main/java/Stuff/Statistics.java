...
public class Statistics implements Serializable {
    ...
    static {
        try {
            ...
            ObjectInputStream input = new ObjectInputStream(new FileInputStream(new File(loader.getResource("file/Statistics").getFile()).getAbsoluteFile()));
    ...
    private void writeFile() {
        try {
            ClassLoader loader = Statistics.class.getClassLoader();
            ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream(new File(loader.getResource("file/Statistics").getFile()).getAbsoluteFile()));
